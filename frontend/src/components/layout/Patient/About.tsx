      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          <p>
            ...
            conveniently and efficiently. At MedicsOnline, we understand the challenges individuals
            face when it comes to scheduling doctor appointments and managing their health records.
          </p>
          <p>
            MedicsOnline is committed to excellence in healthcare technology. We continuously strive
            ...
            ongoing care, MedicsOnline is here to support you every step of the way.
          </p>
          <b className="text-gray-800">Our Vision</b>
          <p>
            Our vision at MedicsOnline is to create a seamless healthcare experience for every user.
